...
**Skill-local protocol** for `/jr-audit --converge`. Mirrors the role of `jr-review/convergence-protocol.md` but with /audit-specific defaults (lower `maxIterations`, advisor at iter ≥ 2 instead of ≥ 3, no fresh-eyes pass).
